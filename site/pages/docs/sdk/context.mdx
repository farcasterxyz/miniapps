...
{
  "accountAssociation": {
    "header": "PUT_YOUR_HEADER_HERE",
    "payload": "PUT_YOUR_PAYLOAD_HERE",
    "signature": "PUT_YOUR_SIGNATURE_HERE"
  },
  "miniapp": {
    "version": "1",
    "name": "عيادة سمر المقطري",
    "iconUrl": "https://clinic.example.com/assets/icon.png",
    "homeUrl": "https://clinic.example.com/app",
    "splashImageUrl": "https://clinic.example.com/assets/splash.png",
    "splashBackgroundColor": "#ffffff",
    "subtitle": "أفضل خدمات طب الأسنان",
    "description": "حجز المواعيد ومتابعة الحالات بسهولة من خلال Farcaster Mini App.",
    "screenshotUrls": [
      "https://clinic.example.com/assets/screenshot1.png",
      "https://clinic.example.com/assets/screenshot2.png"
    ],
    "primaryCategory": "health-fitness",
    "tags": ["clinic", "dentist", "health", "appointments"],
    "heroImageUrl": "https://clinic.example.com/assets/hero.png",
    "tagline": "خدمات طبية متقدمة لأسنانك",
    "ogTitle": "عيادة سمر المقطري",
    "ogDescription": "حجز ومتابعة مواعيد الأسنان بسهولة.",
    "ogImageUrl": "https://clinic.example.com/assets/og.png",
    "requiredChains": [],
