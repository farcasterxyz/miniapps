...
- `cameraAndMicrophoneAccess`: Indicates whether camera and microphone access is available and has been granted. This field is optional and may not be present on all platforms.
