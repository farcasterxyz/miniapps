{
  "miniapp": {
    "version": "1",
    "name": "Gabex Mini App",
    "iconUrl": "https://web3.gabex.io/framesV2/logo.png",
    "homeUrl": "https://web3.gabex.io/framesV2/",
    "imageUrl": "https://web3.gabex.io/framesV2/opengraph-image.png",
    "buttonTitle": "Start on Gabex",
    "splashImageUrl": "https://web3.gabex.io/framesV2/logo.png",
    "splashBackgroundColor": "#050816",
    "subtitle": "Contract trading made easy",
    "description": "Trade perpetual contracts, earn rewards and access onchain features directly from Gabex Mini App on Farcaster.",
    "requiredChains": [
      "eip155:8453"
    ],
...
```json
{
  "miniapp": {
    ...
    "homeUrl": "https://rewards.web3.gabex.io/framesV2/",
