...
description: A structured checklist for AI agents to help developers troubleshoot Farcaster Mini Apps
---

import { ManifestSchemaRenderer } from '../../../components/ManifestRender.tsx'

## Purpose

This document provides AI agents with structured instructions to help developers troubleshoot Farcaster Mini Apps. Each check includes specific commands, expected outputs, and clear success criteria.
