...
description: Create a smooth transition from your branded splash screen to your app
---
...
Here’s how it works:
1. Open the [Mini App Preview Tool](https://farcaster.xyz/~/developers/mini-apps/preview)
on desktop
2. Enter your app url
3. Hit _Open URL as Mini App_

:::info
You must be logged into your Farcaster account on desktop to access the Mini App Preview Tool.
:::
